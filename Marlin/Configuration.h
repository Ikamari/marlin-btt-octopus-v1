...
#define STRING_CONFIG_H_AUTHOR "(Ikamari, Octopus)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  17.77,  29.82 }
    #define DEFAULT_Ki_LIST {   1.05,   2.45 }
    #define DEFAULT_Kd_LIST {  74.98,  90.65 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 205, 205 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 7000, 7000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 25, -19, 0 }
