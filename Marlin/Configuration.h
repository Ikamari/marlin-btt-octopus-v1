...
#define STRING_CONFIG_H_AUTHOR "(Ikamari, Ender3-Octopus)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -6, -1.6 } // { -40, -12, -2.55 }
